...
public class AddWorkout extends Activity implements View.OnClickListener {
    ...
    Workout workout; //Create instance of workout class to hold workout information
    ...
    public void onClick(View v) {
        ...
        try {
            db.insertWorkout(workout); //call insert workout method in Database Center, passing in the workout created above
        } catch (SQLException e) {
            e.printStackTrace();
        }

        Toast.makeText(AddWorkout.this, "Entry Added: " + titleEnt, Toast.LENGTH_SHORT).show(); //make a toast to acknowledge workout added
